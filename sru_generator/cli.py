...
def main():
    ...
    trade_parser = subparsers.add_parser(
        'trades', help='Generate SRU trade file')
    trade_parser.add_argument(
        '--data',
        required=True,
        help='JSON file with trade data')
    trade_parser.add_argument(
        '--personal-number',
        required=True,
        help='Personal number')
    ...
    trade_parser.add_argument(
        '--output',
        default='blanketter.sru',
        help='Output file path')
    trade_parser.add_argument('--crypto-file',
                              help='Optional crypto SRU file to merge')
    trade_parser.add_argument(
    ...
    if args.command == 'info':
        ...
        character_converter = get_character_converter(
            args.character_conversion)
